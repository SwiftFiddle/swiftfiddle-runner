...
function makeSwiftCommand(
  ...
  const options = parameters.options ||
    "-I ./swiftfiddle.com/_Packages/.build/release/Modules/ -I ./_Packages/.build/checkouts/swift-numerics/Sources/_NumericsShims/include/ -L ./swiftfiddle.com/_Packages/.build/release/ -l_Packages -enable-bare-slash-regex";
